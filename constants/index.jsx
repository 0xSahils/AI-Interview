export const features = [
  {
    ...
    caption: "Personalized AI Questions for Every Role",
    title: "Work Smarter, Interview Better",
    text: "Say goodbye to generic practice. Our AI structures interview questions based on your desired job role, tech stack, and experience level—so you’re always interview-ready.",
    button: {
  ...
  },
  {
    ...
    caption: "Soft Skills and Confidence Coaching",
    title: "Real-Time Answer Correction",
    text: "We don’t just stop at technical skills. Our AI trainer evaluates your communication style, speaking clarity, and confidence, offering personalized tips to boost your performance.",
    button: {
...
export const details = [
  {
    ...
    title: "AI-driven Personalized Questions",
  },
  {
    id: "1",
    icon: "/images/detail-2.png",
    title: " Soft Skill and Confidence Evaluation",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    title: "Speech and Delivery Tips",
  },
  {
    id: "4",
    icon: "/images/detail-4.png",
...
export const faq = [
  {
    ...
    answer:
      "It’s as simple as creating an account, selecting your job role, and entering your tech stack. Start practicing immediately!",
  },
  {
    id: "1",
    question: "Can I customize the questions?",
    answer:
      "Yes! Our AI tailors questions based on your inputs and offers flexibility to adjust difficulty as you improve.",
  },
  {
    id: "2",
    question: "Is there support for soft skill development?",
    answer:
      "Absolutely! We analyze not just what you say, but how you say it, helping you build better communication skills.",
  },
  {
    id: "3",
    question: "What if I need help while practicing?",
    answer:
      "We’ve got you covered with 24/7 customer support to answer any questions you may have.",
  },
  {
    id: "4",
    question: "Can teams use this tool?",
    answer:
      "Yes! We offer team plans that include collaboration features and member-specific feedback",
  },
  // {
  //   id: "5",
...
export const plans = [
  {
    ...
    priceMonthly: 19,
    priceYearly: 12,
    caption: "Ideal for freshers and interns.",
    features: [
  ...
  },
  {
    ...
    priceMonthly: 79,
    priceYearly: 59,
    caption: "Most popular plan for mid-level professionals.",
    features: [
  ...
  },
  {
    ...
    priceMonthly: 39,
    priceYearly: 29,
    caption: "Perfect for teams or career coaching groups.",
    features: [
      "All Pro Features",
...
export const testimonials = [
  {
    ...
    comment:
      "The AI feedback on my answers was eye-opening! I’ve never felt this confident before an interview.",
  },
  {
    id: "1",
    name: "Rajat Verma",
    ...
    comment:
      "I love how it helps with both technical and communication skills. This tool is a game-changer!",
  },
  {
    id: "2",
    name: "Priya Mehta",
    ...
    comment:
      "he team mode is fantastic! Our coaching group has benefited a lot from this tool.",
  },
  {
    id: "3",
    name: "Aman Kapoor",
    ...
    comment:
      "Got my dream job with its help! The speech analysis was super useful",
  },
  // {
  //   id: "4",
  //   name: "Becky Snider",
