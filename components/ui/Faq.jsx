...
// import Faq from "./../../app/src/sections/Faq";
// import FaqItem from "./../../app/src/components/FaqItem";
        ...
        <div className="container relative z-2 py-28">
          <div>
            <h3 className="h3 max-md:h5 max-w-640 max-lg:max-w-md mb-7 text-p4">
              Master Every Interview, Every Time.
            </h3>
            <p className="body-1 max-lg:max-w-sm">
              Watch our platform in action to see how it can transform your
